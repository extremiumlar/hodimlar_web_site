/**
 * Professional SVG ikonkalar to'plami (Heroicons uslubida).
 * Barchasi `currentColor` ishlatadi - rangni className orqali boshqarish mumkin.
 */
...
export const BriefcaseIcon = ({ className }: IconProps) => (
  <svg {...base(className)}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.073a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25v-4.072M20.25 14.15A2.25 2.25 0 0021 12.25v-2.5A2.25 2.25 0 0018.75 7.5h-13.5A2.25 2.25 0 003 9.75v2.5c0 .98.626 1.815 1.5 2.122m15.75 0a2.247 2.247 0 01-1.5.572H6a2.247 2.247 0 01-1.5-.572m0 0V9.75m4.5 7.5h6m-6 0v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V17.25m-6 0h6m-9-12.75h.008v.008H6.75V4.5zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM12 4.5h.008v.008H12V4.5z" />
  </svg>
);
...
// Ikonka xaritasi - sidebar uchun nom orqali tanlash
